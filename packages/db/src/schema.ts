...
// Inlined from next-auth/adapters to avoid a dependency on next-auth in this package
...
export const livestreams = pgTable(
  "livestreams",
  {
    ...
    // Schedule
    dayOfWeek: integer("day_of_week").notNull(), // 0=Sun,3=Wed,5=Fri
    scheduledTime: text("scheduled_time").notNull(), // "HH:MM" WAT
